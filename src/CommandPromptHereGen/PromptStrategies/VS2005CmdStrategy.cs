...
{
    /// <summary>
    /// Strategy for a VS2005 command prompt.
    /// </summary>
    public class VS2005CmdStrategy : IPromptStrategy
    {
        /// <summary>
        ...
        {
            get { return Properties.Resources.VS2005CmdStrategy_Accelerator; }
        }
        ...
        public string CommandLine
        {
            ...
            get { return @"%11%\cmd.exe /v:on /k cd /d ""%1"" && ""!VS80COMNTOOLS!vsvars32.bat"""; }
        }
        ...
        public string Name
        {
            get { return Properties.Resources.VS2005CmdStrategy_Name; }
        }
    }
}
