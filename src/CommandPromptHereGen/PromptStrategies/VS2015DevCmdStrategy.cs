...
{
    /// <summary>
    /// Strategy for a VS2015 developer command prompt.
    /// </summary>
    public class VS2015DevCmdStrategy : IPromptStrategy
    {
        /// <summary>
        ...
        {
            get { return Properties.Resources.VS2015DevCmdStrategy_Accelerator; }
        }
        ...
        public string CommandLine
        {
            ...
            get { return @"%11%\cmd.exe /v:on /k cd /d ""%1"" && ""!VS140COMNTOOLS!VsDevCmd.bat"""; }
        }
        ...
        public string Name
        {
            get { return Properties.Resources.VS2015DevCmdStrategy_Name; }
        }
    }
}
