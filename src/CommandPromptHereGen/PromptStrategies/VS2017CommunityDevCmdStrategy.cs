...
{
	/// <summary>
	/// Strategy for a VS2017 Community developer command prompt.
	/// </summary>
	public class VS2017CommunityDevCmdStrategy : IPromptStrategy
	{
		/// <summary>
		...
		{
			get { return Properties.Resources.VS2017CommunityDevCmdStrategy_Accelerator; }
		}
		...
		public string Id
		{
			get { return "VS2017CommunityDevCmdHere"; }
		}
		...
		public string Name
		{
			get { return Properties.Resources.VS2017CommunityDevCmdStrategy_Name; }
		}
	}
}