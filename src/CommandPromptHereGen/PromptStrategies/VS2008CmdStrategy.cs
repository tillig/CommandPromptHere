...
{
	/// <summary>
	/// Strategy for a VS2008 command prompt.
	/// </summary>
	public class VS2008CmdStrategy : IPromptStrategy
	{
		/// <summary>
		...
		{
			get { return Properties.Resources.VS2008CmdStrategy_Accelerator; }
		}
		...
		public string CommandLine
		{
			...
			get { return @"%11%\cmd.exe /v:on /k cd /d ""%1"" && ""!VS90COMNTOOLS!vsvars32.bat"""; }
		}
		...
		public string Name
		{
			get { return Properties.Resources.VS2008CmdStrategy_Name; }
		}
	}
}
