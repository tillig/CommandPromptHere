...
{
    /// <summary>
    /// Strategy for a VS2003 command prompt.
    /// </summary>
    public class VS2003CmdStrategy : IPromptStrategy
    {
        /// <summary>
        ...
        {
            get { return Properties.Resources.VS2003CmdStrategy_Accelerator; }
        }
        ...
        public string CommandLine
        {
            ...
            get { return @"%11%\cmd.exe /v:on /k cd /d ""%1"" && ""!VS71COMNTOOLS!vsvars32.bat"""; }
        }
        ...
        public string Name
        {
            get { return Properties.Resources.VS2003CmdStrategy_Name; }
        }
    }
}
