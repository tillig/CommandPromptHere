...
{
	/// <summary>
	/// Strategy for standard command prompt.
	/// </summary>
	public class CmdStrategy : IPromptStrategy
	{
		/// <summary>
		...
		{
			get { return Properties.Resources.CmdStrategy_Accelerator; }
		}
		...
		{
			get { return @"%11%\cmd.exe /k cd /d ""%1"""; }
		}
		...
		public string Name
		{
			get { return Properties.Resources.CmdStrategy_Name; }
		}
	}
}
