...
{
	/// <summary>
	/// Strategy for a VS2010 (x86) command prompt.
	/// </summary>
	public class VS2010X86CmdStrategy : IPromptStrategy
	{
		/// <summary>
		...
		{
			get { return Properties.Resources.VS2010X86CmdStrategy_Accelerator; }
		}
		...
		public string CommandLine
		{
			...
			get { return @"%11%\cmd.exe /v:on /k cd /d ""%1"" && ""!VS100COMNTOOLS!..\..\VC\vcvarsall.bat"" x86"; }
		}
		...
		public string Name
		{
			get { return Properties.Resources.VS2010X86CmdStrategy_Name; }
		}
	}
}
