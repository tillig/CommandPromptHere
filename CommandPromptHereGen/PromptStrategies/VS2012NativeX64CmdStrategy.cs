...
{
	/// <summary>
	/// Strategy for a VS2012 Native x64 command prompt.
	/// </summary>
	public class VS2012NativeX64CmdStrategy : IPromptStrategy
	{
		/// <summary>
		...
		{
			get { return Properties.Resources.VS2012NativeX64CmdStrategy_Accelerator; }
		}
		...
		public string CommandLine
		{
			...
			get { return @"%11%\cmd.exe /v:on /k cd /d ""%1"" && ""!VS110COMNTOOLS!..\..\VC\vcvarsall.bat"" amd64"; }
		}
		...
		public string Name
		{
			get { return Properties.Resources.VS2012NativeX64CmdStrategy_Name; }
		}
	}
}
